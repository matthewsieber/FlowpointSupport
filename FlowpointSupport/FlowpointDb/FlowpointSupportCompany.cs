...
public partial class FlowpointSupportCompany
{
    ...
    public string VCompanyName { get; set; } = null!;
    ...
    public virtual ICollection<FlowpointSupportVendor> FlowpointSupportVendors { get; set; } = new List<FlowpointSupportVendor>();
}
